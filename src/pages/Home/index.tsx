...
import { NextArrow } from "core-ui/components(common components)/Arrows";
...
const Home: React.FC<{}> = () => {
  ...
  const settings = {
    ...
    slidesToShow: 3,
    slidesToScroll: 1,
    nextArrow: <NextArrow style={undefined} onClick={undefined} />,
    responsive: [
      {
        breakpoint: 1024,
        settings: {
  ...
  return (
    <>
      ...
      <div className="md:px-0 px-3">
        <Slider {...settings}>
          {
            state.pets && state.pets.map((el: any) => {
              return (
        ...
        <div className="hidden md:block">
          <div className="py-12 px-12">
            ...
            <p className="text-white font-normal">
              ...
              <br />
              promote them and get them a home.
            </p>
